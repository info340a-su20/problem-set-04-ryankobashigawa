...
//console.log(extractOpponent(huskyGames2016[3])); //test when UW is away
...
let rivals = huskyGames2016.filter(huskiesLost).map(extractOpponent);
console.log(rivals);
...
//console.log(mostYardsPassing(huskyGames2016[0], huskyGames2016[1]));
...
// - Consider: why do this with `reduce()` instead of `filter()`? //you need to track and compare highest passing game
//
...
//let game1 = makeCombinedFilter(huskiesLost, extractOpponent);
//game1(huskyGames2016[0]);
...
// fumbledAndLostFilter(huskyGames2016);
//let fumbledAndLostFilter = makeCombinedFilter(huskiesLost, extractOpponent);
//fumbledAndLostFilter(huskyGames2016);
...
let testing = huskyGames2016.filter(fumbledAndLostFilter);
console.log(testing);
//console.log(testing);
